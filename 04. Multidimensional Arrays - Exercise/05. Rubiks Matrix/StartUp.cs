namespace _05._Rubiks_Matrix
{
    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            var bluePrint = new int[matrixSize[0], matrixSize[1]];
            var number = 1;
            ...
            {
                var cmdTokens = Console.ReadLine()
                    .Split(new string[] { " " }, StringSplitOptions.RemoveEmptyEntries)
                    .ToArray();

                var index = int.Parse(cmdTokens[0]);
                var command = cmdTokens[1];
                var distance = int.Parse(cmdTokens[2]);
